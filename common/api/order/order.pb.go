...
const file_api_order_order_proto_rawDesc = "" +
	"\n" +
	"\x15api/order/order.proto\x12\x03api\"k\n" +
	...
	"CustomerId\x12*\n" +
	"\x05Items\x18\x02 \x03(\v2\x14.api.CreateOrderItemR\x05Items\"G\n" +
...
var file_api_order_order_proto_goTypes = []any{
	(*CreateOrderItem)(nil),     // 0: api.CreateOrderItem
...
var file_api_order_order_proto_depIdxs = []int32{
	0, // 0: api.CreateOrderRequest.Items:type_name -> api.CreateOrderItem
	1, // 1: api.OrderService.CreateOrder:input_type -> api.CreateOrderRequest
	2, // 2: api.OrderService.CreateOrder:output_type -> api.CreateOrderResponse
